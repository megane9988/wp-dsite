    ...
    class Pdr_Bootstrap{
        ...
        */
        private function initGlobals()
        {
            ...
            define('PDR_ENV', strpos($_SERVER['HTTP_HOST'], '.nky') !== false ? 'development' : 'production');
            ...
            $dev_app = 'http://localhost:8000/dist/main.js?' . md5(uniqid());
            define('PDR_THEAPP', PDR_ENV === 'development' ? $dev_app : '//app.photodropper.com');
        ...
        */
        ...
        {
            $link_markup = '
            <a href="#" title="Find the Right Photo with PhotoDropper" class="pdrp_open button" title="Drop in a Flickr Image">
            <img src="'.get_option('siteurl').'/wp-content/plugins/' . PDR_FOLDER . '/interface/images/photodropper_icon16.png" alt="Drop in a Flickr Image" style="margin-top: -3px; margin-left: -3px;" />
            Find a Photo
            </a>
            ';
            echo $link_markup;
